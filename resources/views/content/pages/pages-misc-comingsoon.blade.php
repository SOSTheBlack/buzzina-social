...
@section('content')
    ...
    <div
        class="misc-wrapper">
        <h4 class="mb-2 mx-2">{{ config('app.name') }}
            será
            lançando
            em
            breve
        ...
        <form
            method="GET"
            action="{{ url()->route('dashboard.home') }}">
            <div
                class="mb-0 d-flex gap-4 align-items-center">
                <input
                    type="text"
        ...
        <div
            ...
            <img
                src="{{ asset('assets/img/illustrations/misc-coming-soon-object.png')}}"
            ...
            <img
                src="{{ asset('assets/img/illustrations/misc-coming-soon-illustration.png')}}"
                alt="misc-coming-soon"
                class="img-fluid z-1"
                width="190">
        </div>
