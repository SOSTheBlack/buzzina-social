    ...
    <div class="authentication-inner row m-0">
      ...
      <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-12 p-6">
        <div class="w-px-400 mx-auto">
          <h4 class="mb-1">Confirme sua senha 🔒</h4>
          <p class="mb-5">Por favor confirme sua senha antes de continuar.</p>
          <form id="twoStepsForm" class="mb-5" action="{{ route('password.confirm') }}" method="POST">
            ...
            <button class="btn btn-primary d-grid w-100">Confirmar Senha</button>
          </form>
        </div>
      </div>
      <!-- /Confirm Password -->
