...
@endphp
    <!-- Navbar: Start -->
<nav
    class="layout-navbar container shadow-none py-0">
    <div
        ...
        <div
            ...
            <a href="javascript:;"
               class="app-brand-link">
                ...
                <span
                    class="app-brand-text demo menu-text fw-semibold ms-2 ps-1">{{ config('app.name') }}</span>
            </a>
        </div>
        ...
        <div
            class="landing-menu-overlay d-lg-none"></div>
        <!-- Menu wrapper: End -->
        <!-- Toolbar: Start -->
