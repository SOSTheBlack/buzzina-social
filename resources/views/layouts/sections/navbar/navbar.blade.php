        ...
        @if(isset($navbarDetached) && $navbarDetached == '')
            <nav
                ...
                <div
                    ...
                    @if(isset($navbarFull))
                        <div
                            class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-6">
                            <a href="{{route('dashboard.home')}}"
                               class="app-brand-link gap-2">
                                <span
                                    class="app-brand-logo demo">@include('_partials.macros',["width"=>25,"withbg"=>'var(--bs-primary)'])</span>
                                <span
                                    class="app-brand-text demo menu-text fw-semibold">{{config('app.name')}}</span>
                            </a>
                                        ...
                                        <a class="dropdown-item"
                                           href="{{ Route::has('profile.show') ? route('profile.show') : 'javascript:void(0);' }}">
                                            <i class="ri-user-3-line ri-22px me-3"></i><span
                                                class="align-middle">Meu Perfil</span>
                                        </a>
                                    </li>
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                               href="{{ route('api-tokens.index') }}">
                                                <i class="ri-key-2-line ri-22px me-3"></i><span
                ...
                <span
                  ...
                  <span
                      class="flex-grow-1 align-middle">Finanças</span>
                </span>
                                        </a>
                                    </li>
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                               href="{{ Auth::user() ? route('teams.show', Auth::user()->currentTeam->id) : 'javascript:void(0)' }}">
                                                <i class="ri-settings-3-line ri-22px me-3"></i><span
                                                    class="align-middle">Configurações da equipe</span>
                                            </a>
                                        </li>
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                   href="{{ route('teams.create') }}">
                                                    <i class="ri-group-line ri-22px me-3"></i><span
                                                        class="align-middle">Criar nova equipe</span>
                                                </a>
                                            </li>
                                        @endcan
                                            ...
                                            <div
                                                ...
                                                <a class="btn btn-sm btn-danger d-flex"
                                                   href="{{ Route::has('login') ? route('login') : url('auth/login-basic') }}">
                                                    <small
                                                        class="align-middle">Login</small>
                                                    <i class="ri-logout-box-r-line ms-2 ri-16px"></i>
                                                </a>
                                            </div>
                                        </li>
